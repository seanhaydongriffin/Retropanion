		...
		Case "images"
			...
			for $i = 0 to (UBound($url_arr) - 1)
				...
				for $j = 0 to (UBound($arr2) - 1) Step 2
					...
					if StringInStr($arr2[$j + 1], "Box - Front") > 0 or StringInStr($arr2[$j + 1], "Box - Back") > 0 or _
					   StringInStr($arr2[$j + 1], "Flyer - Front") > 0 or StringInStr($arr2[$j + 1], "Flyer - Back") > 0 or _
					   StringInStr($arr2[$j + 1], " - Controls Information") > 0 Then
