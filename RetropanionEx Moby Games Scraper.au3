...
$system_dict.Add("Atari 2600", "atari-2600")
$system_dict.Add("Atari 5200", "atari-5200")
$system_dict.Add("Atari 7800", "atari-7800")
$system_dict.Add("Atari 8-bit Family", "atari-8-bit")
$system_dict.Add("Atari Jaguar", "jaguar")
$system_dict.Add("Atari Jaguar CD", "056")
$system_dict.Add("Atari Lynx", "lynx")
...
$system_dict.Add("Bandai WonderSwan", "wonderswan")
$system_dict.Add("Bandai WonderSwan Color / SwanCrystal", "wonderswan-color")
...
$system_dict.Add("Coleco / CBS ColecoVision", "colecovision")
...
$system_dict.Add("Commodore Amiga", "amiga")
...
$system_dict.Add("Magnavox Odyssey^2 / VideoPac", "odyssey-2")
...
$system_dict.Add("Mattel Intellivision", "intellivision")
...
$system_dict.Add("NEC PC Engine / TurboGrafx-16", "turbo-grafx")
...
$system_dict.Add("Nintendo 64", "n64")
$system_dict.Add("Nintendo 64 DD", "084")
$system_dict.Add("Nintendo DS", "nintendo-ds")
...
$system_dict.Add("Nintendo Game Boy", "gameboy")
$system_dict.Add("Nintendo Game Boy Advance", "gameboy-advance")
$system_dict.Add("Nintendo Game Boy Color", "gameboy-color")
$system_dict.Add("Nintendo GameCube", "gamecube")
$system_dict.Add("Nintendo iQue", "124")
$system_dict.Add("Nintendo NES / Famicom", "nes")
$system_dict.Add("Nintendo New Nintendo 3DS", "222")
$system_dict.Add("Nintendo Pok&eacute;mon Mini", "088")
$system_dict.Add("Nintendo SNES / Super Famicom", "snes")
...
$system_dict.Add("Sega 32X", "sega-32x")
$system_dict.Add("Sega Advanced Pico Beena", "200")
$system_dict.Add("Sega AI Computer", "223")
$system_dict.Add("Sega CD / Mega CD", "sega-cd")
$system_dict.Add("Sega Dreamcast", "dreamcast")
$system_dict.Add("Sega Game Gear", "game-gear")
$system_dict.Add("Sega Genesis / Mega Drive", "genesis")
$system_dict.Add("Sega Master System / Mark III", "sega-master-system")
$system_dict.Add("Sega Pico", "059")
$system_dict.Add("Sega Saturn", "sega-saturn")
...
$system_dict.Add("SNK Neo Geo Pocket", "neo-geo-pocket")
$system_dict.Add("SNK Neo Geo Pocket Color", "neo-geo-pocket-color")
$system_dict.Add("SNK Neo Geo X", "204")
$system_dict.Add("Sony PlayStation", "playstation")
$system_dict.Add("Sony PlayStation 2", "ps2")
$system_dict.Add("Sony PlayStation 3", "ps3")
...
if $page_start_page = 0 and $end_page = 0 Then
	...
	Local $iPID = Run('curl.exe -s -k -H "Content-Type: application/x-www-form-urlencoded" https://www.mobygames.com/browse/games/' & $system_dict.Item($system) & '/list-games/', @ScriptDir, @SW_HIDE, $STDOUT_CHILD)
